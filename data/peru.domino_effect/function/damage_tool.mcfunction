...
#max_damage は、componentにない。ツールの種類によって異なる耐久値（木59 石131 鉄250 金32 銅190 ダイヤ1561 ネザライト2031）をそれぞれ持っているアイテムを見てstorageに格納する
...
execute if data entity @s SelectedItem{id:"minecraft:copper_axe"} run data modify storage peru.de:tool max_damage set value 190
...
execute if data entity @s SelectedItem{id:"minecraft:copper_pickaxe"} run data modify storage peru.de:tool max_damage set value 190
